...
OPENMP_FLAGS=-Xpreprocessor -fopenmp \
          -I/opt/homebrew/Cellar/libomp/20.1.3/include \
          -L/opt/homebrew/Cellar/libomp/20.1.3/lib -lomp
...
openmp: sha256_openmp.cpp
	$(CC) sha256_openmp.cpp $(CFLAGS) $(OPENMP_FLAGS) $(LFLAGS) -o sha256_openmp

mpi: sha256_mpi.cpp
	$(MPICXX) sha256_mpi.cpp $(CFLAGS) $(LFLAGS) -o sha256_mpi

sha256: sha256.cpp
	$(CC) sha256.cpp $(CFLAGS) $(LFLAGS) -o sha256
